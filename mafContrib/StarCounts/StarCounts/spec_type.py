...
def spec_type(mass):
   mass_range=[0.06, 0.21, 0.40, 0.51, 0.67, 0.79, 0.92, 1.05, 1.4, 1.6, 2.0, 2.9, 3.8, 5.9, 7.6, 17.5, 23, 37, 60, 120]
   spec_range=[68, 65, 62, 60, 55, 50, 45, 40, 35, 30, 25, 20, 18, 15, 13, 10, 8, 6, 5, 3]
